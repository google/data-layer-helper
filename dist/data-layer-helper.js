...
function n(a,b,c){this.b=a;this.h=void 0===b?function(){}:b;this.f=!1;this.a={};this.c=[];this.g=q(this);t(this,a,!(void 0===c?0:c));var d=a.push,e=this;a.push=function(){var k=[].slice.call(arguments,0),p=d.apply(a,k);t(e,k);return p}}window.DataLayerHelper=n;n.prototype.get=function(a){var b=this.a;a=a.split(".");for(var c=0;c<a.length;c++){if(void 0===b[a[c]])return;b=b[a[c]]}return b};n.prototype.flatten=function(){this.b.splice(0,this.b.length);this.b[0]={};u(this.a,this.b[0])};
