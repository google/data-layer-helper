...
r.prototype.get=function(a){var b=this.b;a=a.split(".");for(var d=0;d<a.length;d++){if(void 0===b[a[d]])return;b=b[a[d]]}return b};r.prototype.flatten=function(){this.f.splice(0,this.f.length);this.f[0]={};q(this.b,this.f[0])};function w(a,b){"set"in a.a||(a.a.set=[]);a.a.set.push(b);a.a.set.push(function(){})}
